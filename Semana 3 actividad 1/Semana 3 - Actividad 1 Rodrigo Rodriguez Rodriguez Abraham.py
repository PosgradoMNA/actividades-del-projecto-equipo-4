...
print(raw)
df = pd.read_csv(raw)
#df.to_csv (r'default of credit card clients.csv', index = False, header=True)
# conversion to CSV
# print(df)
...
basados en lo platicado en clase , el orden si es necesario para que al analizar los datos podamos obtner modelos y
predicciones optimas sin errores ya sea por falta de datos o errores del hombre 
